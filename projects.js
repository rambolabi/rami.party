...
window.RAMI_WORKSHOP = [
    {
        ...
        description: 'Reads your Solis inverters right off their own dataloggers and turns them into a living dashboard: solar power now, battery state of charge, grid import and export, what the sun earned, and month-deep graphs. Works on any tablet in the house, one tap makes it a wall display. All local, nothing to the cloud.',
        search: 'A live local dashboard for Solis solar inverters such as the Solis 3.6K and 4.6K, S6-GR1P3.6K, S6-GR1P4.6K, RHI-3.6K-48ES and other hybrid and string models. Reads the datalogger stick directly on your own network without SolisCloud: Solarman V5 protocol on port 8899 for Wi-Fi sticks, Modbus TCP on port 502 for LAN sticks, or the stick built-in HTTP status page with admin admin login. Shows current solar power in watt, an animated power flow diagram between panels battery house and grid, battery state of charge SOC SOH voltage charge discharge power and time to full, grid meter import and export, house load, money earned and saved from your electricity prices, self-consumption and autarky percentages, CO2 avoided, record peak power and best day, per inverter cards with PV string voltage and current, inverter temperature status and fault alerts, datalogger serial and Wi-Fi signal, and daily monthly and lifetime generation counters. Stores every reading and hourly and daily snapshots in localStorage so a reload never loses data, with 24 hour and 30 day bar charts, a daily ledger table and CSV export. Works on tablets and phones: the relay serves the dashboard on the LAN, a kiosk full screen mode keeps the screen awake for a wall display, and on https it installs as a PWA app. Includes a local Python WebSocket relay bridge and a demo mode. Zonnepanelen omvormer uitlezen, solar PV monitoring, Ginlong Solis.',
    ...
    },
    {
        ...
        description: 'Reads the P1 dongle on your smart meter and turns it into a living dashboard: watts right now, today\u2019s energy, gas and costs, alerts, comparisons and month-deep graphs. Seventeen tiles to arrange, seven themes, night dimming and a kiosk mode for the wall tablet; history stays in your browser.',
        search: 'WattWarden wattwarden.rami.party. A live energy dashboard for the HomeWizard P1 Meter and compatible P1 smart meter dongles, read over the local network API at api v1 data, directly from the browser or through a local Python WebSocket relay. Shows current power usage in watt or kilowatt, imported and exported electricity in kWh per tariff, gas consumption in m3, water meter, voltage current and frequency per phase, monthly peak demand for the Belgian capaciteitstarief, Wi-Fi signal and power failures. Calculates energy costs with tariff 1 and tariff 2 prices, gas and water prices, standing charge, month projection and CO2 footprint. Alerts for high usage, meter offline, voltage out of band, main fuse overload and peak guard, with beep and browser notifications. Stores hourly and daily counter snapshots in localStorage for 60 minute, 24 hour, 7 day, 30 day and 12 month charts with hover tooltips and a cost line, plus JSON and CSV export, import and transfer codes between devices. Seventeen rearrangeable tiles, seven colour themes, custom accent, display scale, compact density, clock, night dimming, wake lock, fullscreen kiosk mode and PWA install for wall tablets. Includes a demo mode with a pretend household. DSMR smart meter, slimme meter uitlezen, energieverbruik.',
