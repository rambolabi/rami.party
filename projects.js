...
window.RAMI_WORKSHOP = [
    ...
    {
        title: 'Breachlight',
        href: 'https://breach.labidi.eu/',
        external: true,
        glyph: '🔦',
        tagline: 'The moment after you clicked',
        description: 'You clicked the link, typed the password, scanned the code, or watched the money leave. Now what? Interactive triage trees that ask a few questions and hand you an actual instruction, a symptom index, 61 playbooks, a 153-term glossary and a defence bench. Two modes: one for the person it happened to, one for the responder, with a deep Active Directory and Entra ID layer, and **Logscope**, an offline log reader that turns an exported Entra or Purview log into a timeline and prioritised findings without uploading anything. Now lives on its own domain.',
    ...
    },
    {
        ...
        glyph: '🚨',
        tagline: 'The moment after you clicked',
        description: 'Incident triage for the worst five minutes of your day: interactive decision trees for phishing, stolen passwords, missing money, malicious QR codes, hijacked accounts and ransomware, in one mode for people and one for responders. Now lives on its own domain.',
    ...
    {
        title: 'Volume Seer',
        href: 'https://mail.labidi.eu/volume/',
        external: true,
        glyph: '📊',
        tagline: 'Charts of the flow',
        description: 'A dashboard visualising email traffic over time. Folded into Mail Ward and now living at mail.labidi.eu/volume/.',
        search: 'A dashboard that visualizes email traffic volume over time with graphs. Email statistics and analytics charts. Part of Mail Ward at mail.labidi.eu.',
        tags: ['tool', 'data'],
        aura: 'pink',
        status: 'live',
    },
