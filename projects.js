...
window.RAMI_WORKSHOP = [
    ...
    },
    {
        ...
        search: 'An email header analyzer and parser. Decode raw email headers to trace the delivery path and hops, read Authentication-Results and SPF DKIM DMARC verdicts, and diagnose spam or email delivery problems.',
        tags: ['tool', 'email'],
        aura: 'violet',
        status: 'live',
    },
    {
        ...
        description: 'A dashboard charting email traffic over time — volumes, spikes and the quiet weekends in between.',
        search: 'An email volume dashboard that visualizes mail traffic over time with graphs and charts. Email statistics and analytics.',
        tags: ['tool', 'data'],
        aura: 'pink',
        status: 'live',
    },
    {
        ...
        href: './breachlight/',
        glyph: '🚨',
        tagline: 'You clicked. Now what?',
        description: 'A calm, step-by-step lantern for the minutes after a phishing click or a suspected breach — what to do first, what to preserve, who to tell, and the jargon explained in plain words.',
        search: 'An incident response guide and first aid checklist for the moment after you clicked a phishing link, opened a suspicious attachment, entered your password on a fake login page or suspect a hack, malware, ransomware or account takeover. Step by step actions to contain the damage, disconnect, change passwords, enable multi factor authentication, preserve evidence, check for mailbox rules and forwarding, and who to report to, plus a glossary of security terms in plain English.',
        tags: ['guide', 'security'],
        aura: 'pink',
        status: 'live',
    },
