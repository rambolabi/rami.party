...
window.RAMI_WORKSHOP = [
    ...
    },
    {
        ...
        href: './militaryalphabet/',
        glyph: '🔤',
        tagline: 'Alpha, Bravo, Charlie…',
        description: 'A terminal-styled reference for the NATO phonetic alphabet — keeps your screen awake while you learn.',
        tags: ['reference', 'toy'],
        aura: 'cyan',
        status: 'live',
    },
