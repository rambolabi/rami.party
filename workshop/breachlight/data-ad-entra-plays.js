...
window.BL_PLAYS.push(
    ...
    /* ------------------------------------------------- AD PERSISTENCE SWEEP */
    {
        ...
        terms: ['acl-abuse', 'sidhistory', 'krbtgt', 'adcs-esc', 'gpo-abuse', 'delegation', 'seamless-sso', 'eradication'],
    ...
    /* -------------------------------------------- ENTRA PERSISTENCE SWEEP -- */
    {
        ...
        terms: ['entra-roles', 'service-principal', 'golden-saml', 'conditional-access', 'pim', 'admin-units', 'cross-tenant', 'gdap', 'ual', 'eradication'],
