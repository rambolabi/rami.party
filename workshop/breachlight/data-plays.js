...
window.BL_PLAYS = [
...

    {
        ...
        terms: ['phishing', 'malvertising', 'clickfix'],
        defend: ['never-click', 'update-everything', 'check-a-link'],
        plays: ['entered-password', 'pasted-command', 'opened-attachment'],
...

    {
        ...
        terms: ['aitm', 'session-hijacking', 'phishing', 'passkey'],
...

    {
        ...
        plays: ['infostealer-home', 'ransomware-home', 'pasted-command'],
...

    {
        ...
        plays: ['entered-password', 'card-fraud', 'fake-shop-purchase'],
...

    {
        ...
        terms: ['bec', 'session-hijacking', 'oauth-consent', 'aitm'],
...

    {
        ...
        terms: ['credential-stuffing', 'session-hijacking', 'sim-swap', 'recovery-scam'],
...

    {
        ...
        terms: ['card-fraud', 'chargeback', 'apr-fraud', 'vishing'],
...

    {
        ...
        terms: ['apr-fraud', 'vishing', 'pig-butchering', 'recovery-scam'],
...

    {
        ...
        terms: ['fake-shop', 'chargeback', 'vcc', 'marketplace-scam'],
...

    {
        ...
        terms: ['pig-butchering', 'advance-fee', 'recovery-scam', 'social-engineering'],
...

    {
        ...
        terms: ['rat', 'vishing', 'social-engineering', 'infostealer'],
        defend: ['verify-a-human', 'money-alarms', 'backups'],
        plays: ['money-transfer', 'infostealer-home', 'card-fraud'],
...

    {
        ...
        sections: [
            ...
            },
            {
                ...
                steps: [
                    ...
                    '**Reinstall the operating system.** Copy off documents only. Do not restore programs or browser profiles.',
        ...
        defend: ['password-hygiene', 'update-everything', 'mfa-upgrade'],
        plays: ['pasted-command', 'opened-attachment', 'mailbox-compromise'],
...

    {
        ...
        plays: ['opened-attachment', 'pro-ransomware'],
...

    {
        ...
        terms: ['shoulder-surfing', 'sim-swap'],
...

    {
        ...
        terms: ['deepfake', 'impersonation', 'vishing', 'code-word'],
...

    {
        ...
        terms: ['data-breach', 'credential-stuffing', 'phishing'],
...

    {
        ...
        terms: ['data-breach', 'credit-freeze', 'doxxing'],
...

    {
        ...
        sections: [
            ...
            },
            {
                ...
                steps: [
                    ...
                    'Unknown apps or profiles on the phone → remove them and change the passwords for anything they could have seen.',
                ],
            },
            {
        ...
        plays: ['mailbox-compromise', 'card-fraud', 'not-sure'],
